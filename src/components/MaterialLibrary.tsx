              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="col-span-2 md:col-span-1">
                  ...
                  <Input
                    ...
                    placeholder="e.g., Special Insulation"
                    className="mt-1"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-4">
              {filteredMaterials.map(material => (
                <button
                  ...
                  className={cn(
                    "material-layer text-left hover:border-primary/50 transition-all group",
                    material.isCustom && "border-primary/30 bg-primary/5"
                  )}
                >
